...
<?php } # endif (canned-resonse-enabled)
    ...
    echo $attrs; ?>><?php echo $_POST ? $info['response'] : $draft;
      ...
      <button type = "submit" style="height:25px;border-radius:7.5px;" formaction = "sms_open.php"><b>Open SMS</b></button>	<!--open sms button created by partha-->
      <button type = "submit" style="height:25px;border-radius:7.5px;" formaction = "sms_close.php"><b>Close SMS</b></button>	<!--close sms button created by partha-->
                </td>
            </tr>
         </tbody>
        </table>
