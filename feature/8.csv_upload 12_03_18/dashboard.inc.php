...
<?php       }
    ...
    <div style="margin-top: 5px"><button type="submit" class="link button" name="export"
        ...
        <?php echo __('Export'); ?></a></button>
	<a style="vertical-align:top;  padding-top: 2.5px; text-decoration: none;" href="custom_table.php">[Custom Table]</a>
	&nbsp;&nbsp;&nbsp;<a style="vertical-align:top;  padding-top: 2.5px; text-decoration: none;" href="info_table.php">[Information Table]</a>
	</div>
    </div>
<?php
}
