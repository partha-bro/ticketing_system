...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH ?>scp/css/jquery-ui.css?9ae093d"/>
	<link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH ?>scp/css/custom_table.css?9ae093d"/>
    <script type="text/javascript" src="<?php echo ROOT_PATH ?>scp/js/jquery-ui.js"></script>
	<script>	
	//custom export
	$( function() {
