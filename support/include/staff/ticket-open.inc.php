...
?>
			...
			<!--<form>
			<input type = "text" name = "call_log_name" placeholder = "Call Logged By:" value="" >
			<input type = "text" name = "mob_number" placeholder = "Mobile No:" value="" >
			<button type = "submit" style="height:25px;border-radius:7.5px;" formaction = "sms_open.php"><b>Open SMS</b></button>		<!--close sms button created by partha-->
    </form>                                 <!--hide by partha 08-10-2018-->
                </td>
            </tr>
             <tr>
